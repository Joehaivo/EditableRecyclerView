...
package com.haivo.editablerecyclerview.helper;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
        ...
        public void onTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent event) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    int absY = Math.abs(y - viewHolder.itemView.getTop());
                    int absX = Math.abs(x - viewHolder.itemView.getLeft());
                    Log.i(TAG, "onTouchEvent: A" + viewHeight + ", " + viewWidth + ", " + absY + ", " + absX);
                    if ((absY > viewHeight * 0.7 && absY < viewHeight)
                            || (absX > viewWidth * 0.7 && absX < viewWidth)) {
                        Log.i(TAG, "onTouchEvent: " + viewHolder);
                        View targetView = mRecyclerView.findChildViewUnder(event.getX(), event.getY());
                        ViewHolder targetViewHolder = mRecyclerView.getChildViewHolder(targetView);
                        if (viewHolder != null && targetViewHolder != null) {
                            mCallback.onMerge(mRecyclerView, viewHolder, targetViewHolder);
                        }
                    }
                    break;
    ...
    public abstract static class Callback {
        ...
        public abstract void onMerge(@NonNull RecyclerView recyclerView,
                                     @NonNull ViewHolder viewHolder, @NonNull ViewHolder target);
